...
const container = document.querySelector('.app--inner') as HTMLDivElement
...
// export type Action = landing.Actions | keyboard.Actions
...
//     }
//     case 'note_on': {
//       if (state.notes[action.note]) return state

//       return {
//         ...state,
//         notes: {...state.notes, [action.note]: {velocity: action.velocity}}
//       }
//     }
//     case 'note_off': {
//       if (!state.notes[action.note]) return state
...
//       delete newState.notes[action.note]
//       return newState
//     }
//     default:
//       return state
